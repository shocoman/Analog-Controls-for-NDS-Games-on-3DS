...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_get_angle_radians, move_hook, camera_hook, update_camera_angle_func, description')
roms_info = {
    "CJRP-2E608754": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020028D8, 0x021CFA44, 0x021CFB98, 0x021C5F74, "Europe v1.0"),
    "CJRJ-D7D749D5": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020028D8, 0x021D4FE4, 0x021D5138, 0x021CB514, "Japan v1.0"),
    "CJRE-A56B15E2": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020028D8, 0x021CFA44, 0x021CFB98, 0x021C5F74, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("GET_ANGLE_FUNC", rom_info.arm9_get_angle_radians),
        ("UPDATE_CAMERA_ANGLE", rom_info.update_camera_angle_func),
    ]
...
def generate_action_replay_code(rom_signature, include_cstick_support):
    ...
    # Movement
    move_hook_addr = rom_info.move_hook
    move_orig_instr = 0xe20000f0
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'cpad_movement')
    move_branch_instr = instr__arm_b(move_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turn X
    cam_turn_x_hook_addr = rom_info.camera_hook
    cam_turn_x_orig_instr = 0xe1a04000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'cstick_camera')
    ...
    ar_code += f"""
        ...
        427FFC3C 00000300
            5{cam_turn_x_hook_addr:07X} {cam_turn_x_orig_instr:08X}
