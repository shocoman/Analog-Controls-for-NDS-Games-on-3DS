...
ARM9_CODE_START_ADDRESS = 0x2001000
...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, ball_move_hook, samus_move_horizontally_hook, samus_move_vertically_hook, camera_turning_hook, toggle_visor_func, description')
roms_info = {
    "AMHP-50A7BAC1": RomInfo(0x037FE9AC, 0x037FEA78, 0x027F6508, 0x037FBA9C, 0x037F84D4, 0x02021DDC, 0x02024B1C, 0x02024F0C, 0x0202430C, 0x02036B18, "Europe v1.0"),
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("TOGGLE_VISOR_FUNC", rom_info.toggle_visor_func)]
...
def generate_action_replay_code(rom_signature):
    ...
    ####################################################################################
    # Arm9 Patch
    code_binary, asm_code = assemble_arm9_patch(rom_signature, "arm9_controls_hook.s")
    ball_roll_offset = find_function_offset_in_asm_listing(asm_code, "BallRolling_Function")
    cam_rot_offset = find_function_offset_in_asm_listing(asm_code, "CameraRotation_Function")
    walk_offset = find_function_offset_in_asm_listing(asm_code, "PlayerWalk_Function")

    # Arm9 Patch. Morph Ball roll
    roll_addr = ARM9_CODE_START_ADDRESS + ball_roll_offset
    ...
    walk_orig_instr = 0xe59d0000  # ldr r0, [sp]

    # Arm9 Patch. Camera rotation
    cam_rot_addr = ARM9_CODE_START_ADDRESS + cam_rot_offset
    cam_hook_addr = rom_info.camera_turning_hook
