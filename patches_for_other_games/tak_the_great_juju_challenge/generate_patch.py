...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_vblank_irq_end_address, arm7_rtc_region_start, arm7_rtc_init_function_call, arm9_code_position, controls_hook, camera_hook, get_angle_func, description')
roms_info = {
    "A3TX-EBFE66A3": RomInfo(0x037FEBBC, 0x037FEC88, 0x037F852C, 0x03800218, 0x037F832C, 0x02004A14, 0x021495B8, 0x021458D4, 0x02031CFC, "Europe v1.0"),
    "A3TE-B5B0E80B": RomInfo(0x037FEBBC, 0x037FEC88, 0x037F852C, 0x03800218, 0x037F832C, 0x02004A14, 0x02149820, 0x02145C60, 0x02031D10, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature, include_cstick_support):
    ...
    # Movement
    movement_hook_addr = rom_info.controls_hook
    movement_orig_instr = 0xe580202c
    ...
    # Camera X
    camera_x_hook_addr = rom_info.camera_hook
    camera_x_orig_instr = 0xe5970024
    camera_x_offset = find_function_offset_in_asm_listing(code_asm_text, "move_camera_x")
    camera_x_branch_instr = instr__arm_b(camera_x_hook_addr, arm9_start_address + camera_x_offset, True)

    # Camera Y
    camera_y_hook_addr = camera_x_hook_addr + 0x78
    camera_y_orig_instr = 0xe5970028
    camera_y_offset = find_function_offset_in_asm_listing(code_asm_text, "move_camera_y")
    camera_y_branch_instr = instr__arm_b(camera_y_hook_addr, arm9_start_address + camera_y_offset, True)
    ...
    ar_code += f"""
        ...
        # Camera X
        427FFC3C 00000200
            5{camera_x_hook_addr:07X} {camera_x_orig_instr:08X}
                0{camera_x_hook_addr:07X} {camera_x_branch_instr:08X}
        D2000000 00000000

        # Camera Y
        427FFC3C 00000200
            5{camera_y_hook_addr:07X} {camera_y_orig_instr:08X}
                0{camera_y_hook_addr:07X} {camera_y_branch_instr:08X}
        D2000000 00000000
