...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_movement_hook_addr, arm9_vec_normalize_func, arm9_vec_length_func, description')
roms_info = {
    "BO5P-3B25DC21": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0214E0D8, 0x01FF852C, 0x0204EC04, "Europe v1.0"),
    "BO5J-A3D9E4AA": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0214DE0C, 0x01FF852C, 0x0204E948, "Japan v1.0"),
    "BO5E-95430ABF": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0214E00C, 0x01FF852C, 0x0204EB44, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ...
        ("VEC_LENGTH_FUNC", rom_info.arm9_vec_length_func),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    movement_hook_addr = rom_info.arm9_movement_hook_addr
    movement_orig_instr = 0x1c28 
