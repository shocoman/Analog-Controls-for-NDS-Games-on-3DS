...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_movement_hook, getangle_func_address, vector3d_length_func_address, description')
roms_info = {
    "B2KJ-424A3F2A": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x020D47CA, 0x020027EC, 0x020025A4, "Japan v1.0"),

    # Eng. ARM7 patched for flashcarts
    # "B2KJ-6127D4AA": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x020D47CA, 0x020027EC, 0x020025A4, "Japan v1.0"),
    # English Patched v1
    # "B2KJ-8D111BFC": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x020D47CA, 0x020027EC, 0x020025A4, "Japan v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("VEC_LENGTH_FUNC", rom_info.vector3d_length_func_address)]
...
def generate_action_replay_code(rom_signature):
    ...
    movement_hook_addr = rom_info.arm9_movement_hook
    movement_orig_instr = 0x1c30
    movement_branch_instr = instr__thumb_bl(movement_hook_addr, arm9_code_address + arm9_offset, True)
