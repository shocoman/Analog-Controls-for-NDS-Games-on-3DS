...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, get_angle_func, sin_cos_lookup_table, description')
roms_info = {
    "BDBP-6A91AAAB": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201C508, 0x020AA440, 0x020C3E7C, "Europe v1.0"),
    "BDBJ-33444081": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201C58C, 0x020A9FD8, 0x020C4FD0, "Japan v1.0"),
    "BDBE-60E207F3": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201C4F8, 0x020AA40C, 0x020C3E88, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    move_A_hook_addr = rom_info.controls_hook
    move_A_orig_instr = 0xe5940514
    move_A_offset = find_function_offset_in_asm_listing(code_asm_text, "move_with_cpad")
