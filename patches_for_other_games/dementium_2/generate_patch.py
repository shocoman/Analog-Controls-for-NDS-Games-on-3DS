...
roms_info = {
    "BDEP-BE559243": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0207A948, 0x0207A084, "Europe v1.0"),
    "BDEE-ADCCFC30": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0207A948, 0x0207A084, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    dude_move_orig_instr = 0xe5950168
    ...
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCameraWithCStick')
