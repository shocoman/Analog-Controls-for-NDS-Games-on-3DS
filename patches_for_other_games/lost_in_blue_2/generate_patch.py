...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_hook_pos, arm9_get_angle_func, description')
roms_info = {
    "AL2P-FA545442": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000A6C, 0x020C3440, 0x02003404, "Europe v1.0"),
    "AL2J-9A03D3F7": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000A6C, 0x020C3154, 0x02003384, "Japan v1.0"),
    "AL2J-DCEA16C6": RomInfo(0x037fe2c4, 0x037fe250, 0x027f5a94, 0x037f84d8, 0x037f8414, 0x02000A6C, 0x020C3540, 0x02003384, "Japan v1.1"),
    "AL2E-DA0C7F5C": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000A6C, 0x020C33E0, 0x02003404, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0x11c010b6
