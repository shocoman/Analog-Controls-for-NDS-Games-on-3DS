...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, movement_control_hook, getangle_func_address, div_func_address, description')
roms_info = {
    "YDQP-AE7BD3F6": RomInfo(0x037FEAA0, 0x037FEA2C, 0x027F5FDC, 0x037F850C, 0x037F8438, 0x02000AB0, 0x020383D0, 0x020C3554, 0x020C2C04, "Europe v1.0"),
    "YDQJ-08CF0EAF": RomInfo(0x037FEAA0, 0x037FEA2C, 0x027F5FDC, 0x037F850C, 0x037F8438, 0x02000AB0, 0x02037E18, 0x020C5010, 0x020C46C0, "Japan v1.0"),
    "YDQE-23A95403": RomInfo(0x037FEAA0, 0x037FEA2C, 0x027F5FDC, 0x037F850C, 0x037F8438, 0x02000AB0, 0x020383C0, 0x020C3544, 0x020C2BF4, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("DIV_FUNC", rom_info.div_func_address),
...
def generate_action_replay_code(rom_signature):
    ...
    # Player Movement
    player_move_hook_addr = rom_info.movement_control_hook
    player_move_orig_instr = 0xe7916102
