...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_movement_hook, arm9_camera_hook, arm9_get_angle_func, arm9_sqrt_func, arm9_trig_table, description')
roms_info = {
    "BFGE-921F9970": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000800, 0x0206C938, 0x0202ACB8, 0x020B4C8C, 0x020B49A0, 0x020C7A70, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("SQRT_FUNCTION", rom_info.arm9_sqrt_func),
        ("GET_ANGLE_FUNCTION", rom_info.arm9_get_angle_func),
        ("TRIG_TABLE", rom_info.arm9_trig_table),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    move_hook_addr = rom_info.arm9_movement_hook
    move_orig_instr = 0x6388
    ...
    # Camera control
    camera_hook_addr = rom_info.arm9_camera_hook
    camera_orig_instr = 0xe3540000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'cstick_camera_control')
    camera_branch_instr = instr__arm_b(camera_hook_addr, arm9_start_address + arm9_offset, True)
    ...
    ar_code += f"""
        ...
        427FFC3C 00000200
            5{camera_hook_addr:07X} {camera_orig_instr:08X}
                0{camera_hook_addr:07X} {camera_branch_instr:08X}
        D2000000 00000000
    """
