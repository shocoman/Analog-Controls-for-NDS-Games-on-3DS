...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook_a, controls_hook_b, controls_hook_c, get_angle_func, sin_cos_lookup_table, description')
roms_info = {
    "CDZP-11F2C3BB": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201F514, 0x020200C4, 0x02020EA0, 0x020B53B0, 0x020D0178, "Europe v1.0"),
    "CG7J-17C19303": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201EC48, 0x0201F7F8, 0x020205D4, 0x020B45F8, 0x020CF2F4, "Japan v1.0"),
    "CG7K-96E2A5E7": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201F000, 0x0201FBB0, 0x0202098C, 0x020B4CE0, 0x020CF9F4, "Korea v1.0"),
    "CDZE-27406AD7": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0201F4A0, 0x02020050, 0x02020E2C, 0x020B51C8, 0x020CFF60, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ...
        ("SIN_COS_LOOKUP_TABLE", rom_info.sin_cos_lookup_table),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    move_A_hook_addr = rom_info.controls_hook_a
    move_A_orig_instr = 0xe59d2184
    move_A_offset = find_function_offset_in_asm_listing(code_asm_text, "entry_a")
    move_A_branch_instr = instr__arm_b(move_A_hook_addr, arm9_start_address + move_A_offset, True)

    move_B_hook_addr = rom_info.controls_hook_b
    move_B_orig_instr = 0xe59d217c
    move_B_offset = find_function_offset_in_asm_listing(code_asm_text, "entry_b")
    move_B_branch_instr = instr__arm_b(move_B_hook_addr, arm9_start_address + move_B_offset, True)

    move_C_hook_addr = rom_info.controls_hook_c
    move_C_orig_instr = 0xe59d20bc
    move_C_offset = find_function_offset_in_asm_listing(code_asm_text, "entry_c")
    move_C_branch_instr = instr__arm_b(move_C_hook_addr, arm9_start_address + move_C_offset, True)
    ...
    ar_code += f"""
        ...
        427FFC3C 00000150
            5{move_A_hook_addr:07X} {move_A_orig_instr:08X}
                0{move_A_hook_addr:07X} {move_A_branch_instr:08X}
        D2000000 00000000

        427FFC3C 00000150
            5{move_B_hook_addr:07X} {move_B_orig_instr:08X}
                0{move_B_hook_addr:07X} {move_B_branch_instr:08X}
        D2000000 00000000

        427FFC3C 00000150
            5{move_C_hook_addr:07X} {move_C_orig_instr:08X}
                0{move_C_hook_addr:07X} {move_C_branch_instr:08X}
        D2000000 00000000
