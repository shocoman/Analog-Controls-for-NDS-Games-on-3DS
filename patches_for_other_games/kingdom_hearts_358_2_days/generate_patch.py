...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_controls_hook, arm9_camera_turn_x, arm9_getangle_func, description')
roms_info = {
    "YKGP-B54EA877": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000A78, 0x20A086C, 0x0204DD80, 0x0200526C, "Europe v1.0"),
    "YKGJ-7F96A5B7": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000A78, 0x20A0434, 0x0204E1A0, 0x02005268, "Japan v1.0"),
    "YKGJ-935551F1": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000A78, 0x20A03F4, 0x0204E160, 0x02005238, "Japan v1.1"),
    "YKGE-826DCE31": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000A78, 0x20A084C, 0x0204dd60, 0x0200524C, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature, include_cstick_support):
    ...
    move_orig_instr = 0xe12fff1e
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'MoveWithCPad')
    move_branch_instr = instr__arm_b(move_hook_addr, arm9_start_address + arm9_offset, False)

    # Camera Turn X
    cam_turn_x_hook_addr = rom_info.arm9_camera_turn_x
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCamera_X')
    cam_turn_x_branch_instr = instr__arm_b(cam_turn_x_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turn Y
    cam_turn_y_hook_addr = rom_info.arm9_camera_turn_x + 0xE0
    cam_turn_y_orig_instr = 0xe2172001
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCamera_Y')
    cam_turn_y_branch_instr = instr__arm_b(cam_turn_y_hook_addr, arm9_start_address + arm9_offset, True)
    ...
    ar_code += f"""
        ...
        427FFC3C 00000400
            ...
            5{move_hook_addr:07X} {move_orig_instr:08X}
                0{move_hook_addr:07X} {move_branch_instr:08X}
            D0000000 00000000

            5{cam_turn_y_hook_addr:07X} {cam_turn_y_orig_instr:08X}
                0{cam_turn_x_hook_addr:07X} {cam_turn_x_branch_instr:08X}
                0{cam_turn_y_hook_addr:07X} {cam_turn_y_branch_instr:08X}
            D0000000 00000000
