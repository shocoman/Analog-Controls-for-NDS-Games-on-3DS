...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, main_movement_control_hook, ship_camera_rotation_control_hook, div32_func_address, getangle_func_address, sqrt_func_address, save_camera_angle_hook, description')
roms_info = {
    "AZEP-D505F823": RomInfo(0x037FE2C4, 0x037FE250, 0x027F5A94, 0x037FB778, 0x037F8414, 0x02000A78, 0x02111748, 0x0214DE60, 0x01FF9B4C, 0x01FFA0F4, 0x01FF9958, 0x020B794C, "Europe v1.0"),
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("DIV_FUNC", rom_info.div32_func_address),
                                  ("GET_ANGLE_FUNC", rom_info.getangle_func_address),
                                  ("SQRT_FUNC", rom_info.sqrt_func_address)]
...
def generate_action_replay_code(rom_signature):
    ...
    player_move_orig_instr = 0xe5900000
    ...
    save_camera_angle_orig_instr = 0xe5941014
    ...
    camera_turn_hook_addr = rom_info.ship_camera_rotation_control_hook
    camera_turn_orig_instr = 0xe1d303b4
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnShipCameraWithCPad')
