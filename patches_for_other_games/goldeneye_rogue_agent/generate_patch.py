...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_vblank_irq_end_address, arm7_rtc_region_start, arm7_rtc_init_function_call, arm9_code_position, arm9_get_angle, controls_hook, update_camera_rotation_func, vec_length_func, trig_table, description')
roms_info = {
    "AGEP-245ECBF4": RomInfo(0x037FF724, 0x037FF7F0, 0x037FBCE4, 0x027D5BA4, 0x037F8454, 0x02003000, 0x02004DF4, 0x0202657C, 0x0202AC00, 0x02004C20, 0x020B135C, "Europe v1.0"),
    "AGEF-27327DF3": RomInfo(0x037FF724, 0x037FF7F0, 0x037FBCE4, 0x027D5BA4, 0x037F8454, 0x02003000, 0x02004DF4, 0x0202657C, 0x0202AC00, 0x02004C20, 0x020B18A4, "France v1.0"),
    "AGEJ-5C8B2B59": RomInfo(0x037FF724, 0x037FF7F0, 0x037FBCE4, 0x027D5BA4, 0x037F8454, 0x02003000, 0x02004DF4, 0x02026608, 0x0202AC8C, 0x02004C20, 0x020B02DC, "Japan v1.0"),
    "AGEE-0D78A8DA": RomInfo(0x037FF724, 0x037FF7F0, 0x037FBCE4, 0x027D5BA4, 0x037F8454, 0x02003000, 0x02004DF4, 0x0202657C, 0x0202AC00, 0x02004C20, 0x020B135C, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("GET_ANGLE_FUNC", rom_info.arm9_get_angle),
        ("UPDATE_CAMERA_ROTATION_FUNC", rom_info.update_camera_rotation_func),
        ("TRIG_LOOKUP_TABLE", rom_info.trig_table),
        ("VEC_LENGTH_FUNC", rom_info.vec_length_func),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    save_speed_hook_addr = rom_info.controls_hook
    save_speed_orig_instr = 0xe3a03000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'save_speed')
    save_speed_branch_instr = instr__arm_b(save_speed_hook_addr, arm9_start_address + arm9_offset, True)
    
    player_move_hook_addr = save_speed_hook_addr + 0x264
    ...
    # Camera Turning
    camera_turn_hook_addr = save_speed_hook_addr - 0x1EC
    camera_turn_orig_instr = 0xe1d60fb4
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'control_camera_cstick')
    ...
    ar_code += f"""
        ...
        427FFC3C 00000350
            5{save_speed_hook_addr:07X} {save_speed_orig_instr:08X}
                0{save_speed_hook_addr:07X} {save_speed_branch_instr:08X}
