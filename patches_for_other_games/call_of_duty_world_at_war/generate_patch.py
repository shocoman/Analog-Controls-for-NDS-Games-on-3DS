...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, move_hook, running_hook, camera_control_hook, get_angle_func, vec3d_length, description')
roms_info = {
    "CALP-72EF25EE": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02003000, 0x020D6674, 0x020D64B8, 0x020D5EC4, 0x020B4F80, 0x020B4D30, "Europe v1.0"),
    "CALK-382B089B": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02003000, 0x020D6674, 0x020D64B8, 0x020D5EC4, 0x020B4F80, 0x020B4D30, "Korea v1.0"),
    "CALE-5E362D9A": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02003000, 0x020D6674, 0x020D64B8, 0x020D5EC4, 0x020B4F80, 0x020B4D30, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("VEC_LENGTH_FUNC", rom_info.vec3d_length),
...
def generate_action_replay_code(rom_signature):
    ...
    dude_move_orig_instr = 0xe2830030
    ...
    # Camera Turning with CStick
    camera_control_hook_addr = rom_info.camera_control_hook
    camera_control_orig_instr = 0xe1a05000 
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'control_camera_with_cstick')
    camera_control_branch_instr = instr__arm_b(camera_control_hook_addr, arm9_start_address + arm9_offset, True)
    
    # running with ZR
    running_hook_addr = rom_info.running_hook
    ...
    ar_code += f"""
        ...
        427FFC3C 00000400
            5{camera_control_hook_addr:07X} {camera_control_orig_instr:08X}
                0{camera_control_hook_addr:07X} {camera_control_branch_instr:08X}
        D2000000 00000000
