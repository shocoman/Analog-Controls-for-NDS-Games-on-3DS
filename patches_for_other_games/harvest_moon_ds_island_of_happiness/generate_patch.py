...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_controls_hook, getangle_address, description')
roms_info = {
    "ABJP-11EAB31C": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x02079054, 0x0201680C, "Europe v1.0"),
    "ABJJ-3B17CBEF": RomInfo(0x037FEAEC, 0x037FEBB8, 0x027F694C, 0x037FBB94, 0x037F84E0, 0x02000A78, 0x0207D90C, 0x02016F8C, "Japan v1.0"),
    "ABJE-5A78B099": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x02078828, 0x0201680C, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("GET_ANGLE_FUNC", rom_info.getangle_address),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    movement_hook_addr = rom_info.arm9_controls_hook
    movement_orig_instr = 0xe1a01000 
    ...
    # Fake touch screen press
    fake_tsc_hook_addr = movement_hook_addr - 0x94
    fake_tsc_offset = find_function_offset_in_asm_listing(code_asm_text, "fake_touchscreen")
    fake_tsc_branch_instr = instr__arm_b(fake_tsc_hook_addr, arm9_start_address + fake_tsc_offset, True)
    fake_tsc_2_hook_addr = movement_hook_addr + 0x10
    fake_tsc_2_branch_instr = instr__arm_b(fake_tsc_2_hook_addr, arm9_start_address + fake_tsc_offset, True)
    ...
    ar_code += f"""
        ...
        427FFC3C 00000150
            5{movement_hook_addr:07X} {movement_orig_instr:08X}
                ...
                0{fake_tsc_hook_addr:07X} {fake_tsc_branch_instr:08X}
                0{fake_tsc_2_hook_addr:07X} {fake_tsc_2_branch_instr:08X}
        D2000000 00000000
