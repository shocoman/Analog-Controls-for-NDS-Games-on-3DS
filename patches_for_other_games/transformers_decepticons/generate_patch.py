...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, move_hook, vehicle_controls_hook, get_angle_func, description')
roms_info = {
    "AFYP-E03A6127": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "Europe v1.0"),
    "AFYP-337A2653": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23C0, 0x020E0F58, 0x020055F0, "Europe v1.1"),
    "AFYF-F7DF31F9": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "France v1.0"),
    "AFYD-C34A5CB1": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "Germany v1.0"),
    "AFYI-7AC58ED4": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "Italy v1.0"),
    "AFYS-4E2D61C3": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "Spain v1.0"),
    "AFYS-921A19DF": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23C0, 0x020E0F58, 0x020055F0, "Spain v1.1"),
    "AFYE-86F6202B": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23BC, 0x020E0F54, 0x020055F0, "USA v1.0"),
    "AFYE-4F365A44": RomInfo(0x037FFAB8, 0x037FFB84, 0x027F6BDC, 0x037FBBD4, 0x037F8520, 0x02000A78, 0x020D23C0, 0x020E0F58, 0x020055F0, "USA v1.1"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("GET_ANGLE_FUNC", rom_info.get_angle_func),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    movement_hook_addr = rom_info.move_hook
    movement_orig_instr = 0xe58411b0
    ...
    # Vehicle controls
    control_vehicle_hook_addr =  rom_info.vehicle_controls_hook
    control_vehicle_orig_instr = 0xe1a01601
    control_vehicle_offset = find_function_offset_in_asm_listing(code_asm_text, "control_vehicle")
    control_vehicle_branch_instr = instr__arm_b(control_vehicle_hook_addr, arm9_start_address + control_vehicle_offset, True)
    ...
    ar_code += f"""
        ...
        # steering vehicle
        427FFC3C 00000100
            5{control_vehicle_hook_addr:07X} {control_vehicle_orig_instr:08X}
                0{control_vehicle_hook_addr:07X} {control_vehicle_branch_instr:08X}
        D2000000 00000000

        # general controls (walking, using scanner)
        427FFC3C 00000100
