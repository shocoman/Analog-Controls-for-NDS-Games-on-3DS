...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, description')
roms_info = {
    "AMOP-C2C6149B": RomInfo(0x037FE5A8, 0x037FE674, 0x027F5CFC, 0x037FB878, 0x037F84E4, 0x02000A5C, 0x02047220, "Europe v1.0"),
    "AMOJ-51F70EDB": RomInfo(0x037FE5A8, 0x037FE674, 0x027F5CFC, 0x037FB878, 0x037F84E4, 0x02000A5C, 0x02046EB0, "Japan v1.0"),
    "AMOE-24755900": RomInfo(0x037FE5A8, 0x037FE674, 0x027F5CFC, 0x037FB878, 0x037F84E4, 0x02000A5C, 0x0204727C, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0xe3a01000
