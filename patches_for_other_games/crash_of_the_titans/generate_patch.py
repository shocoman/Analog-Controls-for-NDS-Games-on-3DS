...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, get_angle_func, description')
roms_info = {
    "AQJP-65159598": RomInfo(0x037FEAEC, 0x037FEBB8, 0x027F694C, 0x037FBB94, 0x037F84E0, 0x02000A78, 0x0202EB18, 0x0202F984, "Europe v1.0"),
    "AQJE-0D2F3342": RomInfo(0x037FEAEC, 0x037FEBB8, 0x027F694C, 0x037FBB94, 0x037F84E0, 0x02000A78, 0x0202EAD0, 0x0202F93C, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0xe12fff1e
    movement_offset = find_function_offset_in_asm_listing(code_asm_text, "move_with_cpad")
    movement_branch_instr = instr__arm_b(movement_hook_addr, arm9_start_address + movement_offset, False)
