...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, move_hook, camera_turn_with_keys_hook, camera_turn_with_touchscreen_hook, vec3d_length, getangle_func_address, description')
roms_info = {
    "BJCZ-6BB700D7": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "Canada v1.0"),
    "BJCP-B307FB57": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "United Kingdom v1.0"),
    "BJCF-598D1515": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "France v1.0"),
    "BJCD-51F0FAA9": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "Germany v1.0"),
    "BJCI-D045489C": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "Italy v1.0"),
    "BJCS-9A6F30AD": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "Spain v1.0"),
    "BJCE-E3D9F896": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B69C4, 0x020B9BCC, 0x020BF7D4, 0x020FE4FC, 0x020FE744, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    player_move_hook_addr = rom_info.move_hook
    player_move_orig_instr = 0xe0806607
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'MoveWithCPad')
    player_move_branch_instr = instr__arm_b(player_move_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turning with Buttons
    camera_turn_hook_addr = rom_info.camera_turn_with_keys_hook
    camera_turn_orig_instr = 0xe3500000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCameraWithKeys')
    ...
    camera_turn_tsc_y_hook_addr = rom_info.camera_turn_with_touchscreen_hook
    camera_turn_tsc_y_orig_instr = 0xe1a02000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCameraWithTouchscreen_Y')
    camera_turn_tsc_y_branch_instr = instr__arm_b(camera_turn_tsc_y_hook_addr, arm9_start_address + arm9_offset, True)

    camera_turn_tsc_x_hook_addr = rom_info.camera_turn_with_touchscreen_hook + 0xFC
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCameraWithTouchscreen_X')
    camera_turn_tsc_x_branch_instr = instr__arm_b(camera_turn_tsc_x_hook_addr, arm9_start_address + arm9_offset, True)
    ...
    ar_code += f"""
        ...
        42FFFC3C 00000350
            5{camera_turn_tsc_y_hook_addr:07X} {camera_turn_tsc_y_orig_instr:08X}
                0{camera_turn_tsc_y_hook_addr:07X} {camera_turn_tsc_y_branch_instr:08X}
                0{camera_turn_tsc_x_hook_addr:07X} {camera_turn_tsc_x_branch_instr:08X}
        D2000000 00000000
    """
