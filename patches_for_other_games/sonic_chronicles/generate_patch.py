...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_controls_hook, description')
roms_info = {
    "CSNP-0742A221": RomInfo(0x037FE39C, 0x037FE324, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000AB0, 0x0204D138, "Europe v1.0"),
    "C5RJ-6CF4F788": RomInfo(0x037FE39C, 0x037FE324, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000AB0, 0x0204D428, "Japan v1.0"),
    "YWSE-ACB0DF12": RomInfo(0x037FE39C, 0x037FE324, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000AB0, 0x0204D170, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    fake_tsc_hook_addr = rom_info.arm9_controls_hook
    fake_tsc_orig_instr = 0xa902
    ...
    fake_tsc_2_hook_addr = rom_info.arm9_controls_hook + 0x60
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'fake_touchscreen_press_part2')
    fake_tsc_2_branch_instr = instr__thumb_bl(fake_tsc_2_hook_addr, arm9_start_address + arm9_offset, True)

    # Movement
    move_hook_addr = rom_info.arm9_controls_hook + 0x10E
    ...
    ar_code += f"""
        ...
        427FFC3C 00000400
            9{fake_tsc_hook_addr:07X} {fake_tsc_orig_instr:08X}
                1{fake_tsc_hook_addr+0:07X} {fake_tsc_branch_instr[0]:08X}
                1{fake_tsc_hook_addr+2:07X} {fake_tsc_branch_instr[1]:08X}
                1{fake_tsc_2_hook_addr+0:07X} {fake_tsc_2_branch_instr[0]:08X}
                1{fake_tsc_2_hook_addr+2:07X} {fake_tsc_2_branch_instr[1]:08X}
