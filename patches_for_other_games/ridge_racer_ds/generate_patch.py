...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_vblank_irq_end_address, arm7_rtc_region_start, arm7_rtc_init_function_call, arm9_code_position, controls_hook, description')
roms_info = {
    "ARRE-590D06E0": RomInfo(0x037FE4B8, 0x037FE584, 0x037FBBF0, 0x0380595C, 0x037F836C, 0x020049F0, 0x02040B8C, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0xe1c230b0
