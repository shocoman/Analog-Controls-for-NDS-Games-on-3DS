...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_movement_hook, arm9_get_angle_func, description')
roms_info = {
    "YOGP-55AC6679": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0205A1E4, 0x02002EA4, "Europe v1.0"),
    "YOGJ-A176530A": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5CA0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x02067494, 0x02002F68, "Japan v1.0"),
    "YOGE-53AC1A52": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x0205A0D4, 0x02002EA4, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    move_branch_instr = move_branch_instr & 0x0FFF_FFFF # make conditional on equal
