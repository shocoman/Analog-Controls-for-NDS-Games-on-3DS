...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_crackers_dpad_hook, arm9_crackers_dpad_hook_return, arm9_crackers_boostbrake_hook, arm9_crackers_boostbrake_hook_return, arm9_crackers_key_mask_addr, description')
roms_info = {
    "ASFP-F0E8BD5C": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000000, 0x021E9434, 0x021E943D, 0x021EDBCC, 0x021EDBD5, 0x0203D468, "Europe v1.0"),
    "ASFJ-70977801": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000000, 0x021E9C18, 0x021E9C21, 0x021EE3B0, 0x021EE3B9, 0x0203D414, "Japan v1.0"),
    "ASFE-F22E6A7D": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000000, 0x021E9D34, 0x021E9D3D, 0x021EE4CC, 0x021EE4D5, 0x0203D414, "USA v1.0"),
}
