...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_controls_hook, is_movement_allowed_var, keys_held_var, camera_left_func, vector_length_func, description')
roms_info = {
    "COZJ-CFD46404": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5CA0, 0x037F84D8, 0x037F8414, 0x02000800, 0x02024F0C, 0x020C51B8, 0x020C3804, 0x020260EC, 0x01FF9450, "Japan v1.0"),
    "COZE-8E18A92A": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5CA0, 0x037F84D8, 0x037F8414, 0x02000800, 0x02024F3C, 0x020C6138, 0x020c4784, 0x0202611C, 0x01FFDF88, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("KEYS_HELD_ADDRESS", rom_info.keys_held_var),
        ("TURN_CAMERA_LEFT_FUNC", rom_info.camera_left_func),
        ("IS_ALLOWED_TO_MOVE_PTR", rom_info.is_movement_allowed_var),
        ("VECTOR_LENGTH_FUNC", rom_info.vector_length_func),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0xe5971588
