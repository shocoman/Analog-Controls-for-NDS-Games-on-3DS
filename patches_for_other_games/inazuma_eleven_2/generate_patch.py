...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_move_hook, arm9_get_angle_func, description')
roms_info = {
    "BEEP-2972B963": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210CCDC, 0x0200226C, "Firestorm, Europe v1.0"),
    "BEBP-E653FBE6": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210CCDC, 0x0200226C, "Blizzard, Europe v1.0"),
    "BEEF-00BA0675": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D2FC, 0x0200226C, "Tempete de Feu, France v1.0"),
    "BEBF-AAB8EF1A": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D2FC, 0x0200226C, "Tempete de Glace, France v1.0"),
    "BEBD-45B02CC4": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D17C, 0x0200226C, "Eissturm, Germany v1.0"),
    "BEED-22E2CDFA": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D17C, 0x0200226C, "Feuersturm, Germany v1.0"),
    "BEBI-063873F4": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210CF3C, 0x0200226C, "Bufera di Neve, Italy v1.0"),
    "BEEI-B2F755C4": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210CF3C, 0x0200226C, "Tempesta di Fuoco, Italy v1.0"),
    "BEBJ-E2D47023": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020FB890, 0x020091C8, "Kyoui no Shinryakusha - Blizzard, Japan v1.0"),
    "BEEJ-C4F12B43": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020FB7CC, 0x020091C8, "Kyoui no Shinryakusha - Fire, Japan v1.0"),
    "BEBJ-10090AB0": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020FBAA4, 0x020091C8, "Kyoui no Shinryakusha - Blizzard, Japan v1.1"),
    "BEEJ-F62613D1": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020FB9E0, 0x020091C8, "Kyoui no Shinryakusha - Fire, Japan v1.1"),
    "BEBS-F22A7C91": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D11C, 0x0200226C, "Ventisca Eterna, Spain v1.0"),
    "BEES-1289D16C": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02000A78, 0x0210D11C, 0x0200226C, "Tormenta de Fuego, Spain v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("VEC_ANGLE_FUNC", rom_info.arm9_get_angle_func),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    movement_hook_addr = rom_info.arm9_move_hook
    movement_orig_instr = 0xe19020b1
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'move_with_cpad')
    movement_branch_instr = instr__arm_b(movement_hook_addr, arm9_start_address + arm9_offset, True)

    frame_counter_addr = 0x27FFC3C if "Japan" in rom_info.description else 0x2FFFC3C

    ar_code += f"""
        # wait for some time, just to be sure (0x2FFFC3C is a frame counter)
        4{frame_counter_addr:07X} 00000100
        ...
        4{frame_counter_addr:07X} 00000200
