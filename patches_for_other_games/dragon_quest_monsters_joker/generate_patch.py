...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_get_angle_radians, move_hook, camera_hook, description')
roms_info = {
    "AJRP-A37FF7D0": RomInfo(0x037FE29C, 0x037FE228, 0x027F5B18, 0x037F84D8, 0x037F8414, 0x02000A78, 0x0200243C, 0x021BC220, 0x021BC2B4, "Europe v1.0"),
    # "AJRJ-77DA0950": RomInfo([], [], [], [], [], 0x02000A6C, [], [], [], "Japan v1.0"), # completely different offsets
    "AJRE-5EEB7B5B": RomInfo(0x037FE29C, 0x037FE228, 0x027F5B18, 0x037F84D8, 0x037F8414, 0x02000A78, 0x0200243C, 0x021D7BB0, 0x021D7C44, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature, include_cstick_support):
    ...
    cam_turn_x_orig_instr = 0xe2080c03
