...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_move_hook, arm9_turn_camera_x_hook, arm9_turn_camera_y_hook, arm9_getangle_func, description')
roms_info = {
    "BK9P-5060245E": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037FBC18, 0x037F8324, 0x02000A78, 0x020A6FAE, 0x020C4256, 0x020C4388, 0x020062D0, "Europe v1.0"),
    "BK9J-34A21EC0": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037FBC18, 0x037F8324, 0x02000A78, 0x020A6A4E, 0x020C3C76, 0x020C3DA8, 0x0200623C, "Japan v1.0"),
    "BK9E-B2D419DE": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037FBC18, 0x037F8324, 0x02000A78, 0x020A6F8E, 0x020C4236, 0x020C4368, 0x020062BC, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature, include_cstick_support):
    ...
    # Movement
    walk_hook_addr = rom_info.arm9_move_hook
    walk_orig_instr = 0x2c01
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'MoveWithCPad')
    walk_branch_instr = instr__thumb_bl(walk_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turn X
    cam_turn_x_hook_addr = rom_info.arm9_turn_camera_x_hook
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCamera_X')
    cam_turn_x_branch_instr = instr__thumb_bl(cam_turn_x_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turn Y
    cam_turn_y_hook_addr = rom_info.arm9_turn_camera_y_hook
    cam_turn_y_orig_instr = 0x4030
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCamera_Y')
    cam_turn_y_branch_instr = instr__thumb_bl(cam_turn_y_hook_addr, arm9_start_address + arm9_offset, True)
