...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_controls_hook_insertion_point, arm9_code_position, arm9_div_function, arm9_camera_state, description')
roms_info = {
    "YNJP-CC220989": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037FB788, 0x037F8414, 0x02026D30, 0x02000AB0, 0x0206D454, 0x020964B4, "Europe v1.0"),
    "YNJE-35759484": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037FB788, 0x037F8414, 0x02026D18, 0x02000AB0, 0x0206D43C, 0x02096494, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("DIV_FUNC", rom_info.arm9_div_function),
                                  ("CAMERA_STATE", rom_info.arm9_camera_state)]
