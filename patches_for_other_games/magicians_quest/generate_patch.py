...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, movement_control_hook, div_func_address, vec_length_func_address, description')
roms_info = {
    "YNNP-86C62016": RomInfo(0x037FE39D, 0x037FE325, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000A78, 0x020277EE, 0x01FF8000, 0x01FF92D0, "Europe v1.0"),
    "YNNJ-0523EF7A": RomInfo(0x037FE39D, 0x037FE325, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000A78, 0x0202757A, 0x01FF8000, 0x01FF92D0, "Japan v1.0"),
    "YNNJ-B4F8266C": RomInfo(0x037FE39D, 0x037FE325, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000A78, 0x020275CE, 0x01FF8000, 0x01FF92D0, "Japan v1.1"),
    "YNNE-B7C575AD": RomInfo(0x037FE39D, 0x037FE325, 0x027F5D48, 0x037FB718, 0x037F82D8, 0x02000A78, 0x02027802, 0x01FF8000, 0x01FF92D0, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("DIV_FUNC", rom_info.div_func_address),
        ("VEC_LENGTH_FUNC", rom_info.vec_length_func_address),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Player Movement
    hook_addr = rom_info.movement_control_hook
    orig_instr = 0x32a2
