...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, move_hook, camera_hook, description')
roms_info = {
    "YDTP-43C69E7E": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x02055C80, 0x02055170, "Europe v1.0"),
    "YDTJ-AFA783E4": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5CA0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x0205566C, 0x02054B5C, "Japan v1.0"),
    "YDTE-8D709AEA": RomInfo(0x037FE29C, 0x037FE228, 0x027F5B18, 0x037F84D8, 0x037F8414, 0x02000A78, 0x0205103C, 0x02050520, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    dude_move_orig_instr = 0xe5880120 
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'move_with_cpad')
    player_move_branch_instr = instr__arm_b(dude_move_hook_addr, arm9_start_address + arm9_offset, True)

    # Camera Turning
    camera_turn_hook_addr = rom_info.camera_hook
    camera_turn_orig_instr = 0xe3560000  
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'turn_camera_with_cstick')
