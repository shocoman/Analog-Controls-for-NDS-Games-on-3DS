...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, move_hook, run_hook, camera_turn_with_keys_hook, camera_turn_with_touchscreen_hook, vec3d_length, div32, camera_settings, description')
roms_info = {
    "BDYX-7F37D348": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B118C, 0x020B0D74, 0x020C0C10, 0x020BA0F4, 0x0215624C, 0x0200E66C, 0x021be9b4, "Canada v1.0"),
    "BDYP-BC372203": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B1194, 0x020B0D7C, 0x020C0C18, 0x020BA0FC, 0x02156254, 0x0200E674, 0x021be9b4, "United Kingdom v1.0"),
    "BDYY-0C8EB6A9": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B11A8, 0x020B0D90, 0x020C0C2C, 0x020BA110, 0x02156268, 0x0200E688, 0x021be9b4, "Europe v1.0"),
    "BDYF-AC733DEC": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B1190, 0x020B0D78, 0x020C0C14, 0x020BA0F8, 0x02156534, 0x0200E670, 0x021BECF4, "France v1.0"),
    "BDYD-0EA39166": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B1190, 0x020B0D78, 0x020C0C14, 0x020BA0F8, 0x02156250, 0x0200E670, 0x021be9b4, "Germany v1.0"),
    "BDYE-DB518CE8": RomInfo(0x037FEBEC, 0x037FEB7C, 0x027E0000, 0x037F8464, 0x037F8324, 0x02003000, 0x020B1190, 0x020B0D78, 0x020C0C14, 0x020BA0F8, 0x02156250, 0x0200E670, 0x021be9b4, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ...
        ("CAMERA_SETTINGS", rom_info.camera_settings),
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    dude_move_orig_instr = 0xe586031c
    ...
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'RunWithZR')
    ...
    camera_turn_orig_instr = 0xe5990000
    ...
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnCameraWithTouchscreen')
