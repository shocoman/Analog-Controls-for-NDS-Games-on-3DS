...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, getangle_func_address, vec2d_length_func_address, game_state_addr, description')
roms_info = {
    "BRFP-394F533B": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020A93DC, 0x0210FF00, 0x0200E438, 0x22B9160, "Europe v1.0"),
    "BRFJ-E4EE046A": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020A8AE8, 0x0210E394, 0x0200E3A0, 0x22B0E60, "Japan v1.0"),
    "BRFE-651FEEC3": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020A93DC, 0x0210FF00, 0x0200E438, 0x22B9160, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ...
        ("GAME_STATE_STRUCT", rom_info.game_state_addr)
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    player_move_orig_instr = 0xe1a02000
