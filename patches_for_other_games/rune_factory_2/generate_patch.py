...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, vec_normalize_address, description')
roms_info = {
    "A6NP-C1FEEE1E": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020133BC, 0x020C5840, "Europe v1.0"),
    "A6NJ-63DD3B2A": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5C80, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020138AC, 0x020C681C, "Japan v1.0"),
    "A6NJ-56B65880": RomInfo(0x037FE3DC, 0x037FE368, 0x027F5C80, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020138AC, 0x020C68B0, "Japan v1.1"),
    "A6NE-4B1C80A4": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x02013610, 0x020C58BC, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    movement_orig_instr = 0xe28d0000
