...
# ARM9_CODE_START_ADDRESS = 0x02000A78  # there goes the arm9 protection unit setup
...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, main_movement_control_hook, train_camera_control_hook, div32_func_address, getangle_func_address, vec2d_length_func_address, save_camera_angle_hook, description')
roms_info = {
    "BKIP-48C96A52": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02094FAC, 0x021306D4, 0x0203A1BC, 0x01FFBBE0, 0x01FF9258, 0x020BE504, "Europe v1.0"),
    "BKIP-2545185D": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02095000, 0x021307F4, 0x0203A1BC, 0x01FFBBE0, 0x01FF9258, 0x020BE544, "Europe v1.1"),
    "BKIJ-E6ABCF14": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02096760, 0x021329F8, 0x0203B6EC, 0x01FFBBE0, 0x01FF9258, 0x020BFD30, "Japan v1.0"),
    "BKIE-94771A5D": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02094F8C, 0x021306B4, 0x0203A194, 0x01FFBBE0, 0x01FF9258, 0x020BE4E4, "USA v1.0"),
    "BKIE-EBB51682": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02094FE0, 0x021307D4, 0x0203A194, 0x01FFBBE0, 0x01FF9258, 0x020BE524, "USA v1.1"),

    # dpad mod
    # "BKIE-5818C636": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x02094F8C, 0x021306B4, 0x0203A194, 0x01FFBBE0, 0x01FF9258, 0x020BE4E4, "USA v1.0"),

    # alternative version?
    # "BKIE-94771A5D": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020be554, 0x021306B4, 0x0203A194, 0x01FFBBE0, 0x01FF9258, 0x020BE4E4, "USA v1.0"),
    # "BKIE-5818C636": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CD0, 0x037F84D8, 0x037F8414, 0x02000A78, 0x020be554, 0x021306B4, 0x0203A194, 0x01FFBBE0, 0x01FF9258, 0x020BE4E4, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [("DIV32_FUNC", rom_info.div32_func_address),
                                  ("GET_ANGLE_FUNC", rom_info.getangle_func_address),
                                  ("VEC2D_LENGTH_FUNC", rom_info.vec2d_length_func_address)]
...
def generate_action_replay_code(rom_signature):
    ...
    # Player Movement
    player_move_hook_addr = rom_info.main_movement_control_hook
    player_move_orig_instr = 0xe1da05ba
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'MovePlayerWithCPad')
    player_move_branch_instr = instr__arm_b(player_move_hook_addr, arm9_start_address + arm9_offset, True, True)

    # Save the camera angle to set Link's direction properly
    save_camera_hook_addr = rom_info.save_camera_angle_hook
    save_camera_angle_orig_instr = 0xe1a08000
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'SaveCameraAngle')
    save_camera_angle_branch_instr = instr__arm_b(save_camera_hook_addr, arm9_start_address + arm9_offset, True, True)

    # Train Camera Turning
    camera_turn_hook_addr = rom_info.train_camera_control_hook
    camera_turn_orig_instr = 0xe594200c
    arm9_offset = find_function_offset_in_asm_listing(code_asm_text, 'TurnTrainCameraWithCPad')
    camera_turn_branch_instr = instr__arm_b(camera_turn_hook_addr, arm9_start_address + arm9_offset, True, True)
