...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, arm9_hook_pos, arm9_hook_pos_b, arm9_vec_normalize, description')
roms_info = {
    "AWUP-6786263A": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000A6C, 0x02121838, 0x02121D10, 0x02061E7C, "Europe v1.0"),
    "AWUE-BB6B3A9A": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x02000A6C, 0x02121838, 0x02121D10, 0x02061E7C, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        ("VEC_NORMALIZE", rom_info.arm9_vec_normalize)
    ]
...
def generate_action_replay_code(rom_signature):
    ...
    # Movement
    movement_hook_addr = rom_info.arm9_hook_pos
    movement_orig_instr = 0xe28d007c
    movement_offset = find_function_offset_in_asm_listing(code_asm_text, "move_with_cpad_a")
    movement_branch_instr = instr__arm_b(movement_hook_addr, arm9_start_address + movement_offset, True)

    # Movement B
    movement_b_hook_addr = rom_info.arm9_hook_pos_b
    movement_b_orig_instr = 0xe59d10b8
    movement_b_offset = find_function_offset_in_asm_listing(code_asm_text, "move_with_cpad_b")
    movement_b_branch_instr = instr__arm_b(movement_b_hook_addr, arm9_start_address + movement_b_offset, True)
    ...
    ar_code += f"""
        ...
        427FFC3C 00000150
            5{movement_b_hook_addr:07X} {movement_b_orig_instr:08X}
