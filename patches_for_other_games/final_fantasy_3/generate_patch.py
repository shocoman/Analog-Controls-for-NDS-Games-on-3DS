...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_controls_hook_insertion_point, arm9_code_position, description')
roms_info = {
    "AFFP-AC31DBEB": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x020D9698, 0x02000A6C, "Europe v1.0"),
    "AFFJ-21E3EA0A": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x020D7E30, 0x02000A6C, "Japan v1.0"),
    "AFFE-7A99FB3C": RomInfo(0x037FE9EC, 0x037FEAB8, 0x027F6798, 0x037FBAB4, 0x037F84E0, 0x020D83BC, 0x02000A6C, "USA v1.0"),
}
...
def assemble_arm9_patch(rom_signature, asm_filename):
    ...
    arm9_defines_for_assembler = [
        # ("DIV_FUNC", rom_info.arm9_div_function)
        ]
...
def generate_action_replay_code(rom_signature):
    ...
    player_move_orig_instr = 0xe0211094
