...
RomInfo = namedtuple(
    'RomInfo',
    'arm7_ipc_send_msg, arm7_set_ipc_channel_handler, arm7_rtc_region_start, arm7_vblank_irq_end_address, arm7_rtc_init_function_call, arm9_code_position, controls_hook, getangle_func_address, description')
roms_info = {
    "CJKE-E743CCCE": RomInfo(0x037FE410, 0x037FE39C, 0x027F5CC4, 0x037F84D8, 0x037F8414, 0x02000AB0, 0x020D32B0, 0x02002BF4, "USA v1.0"),
}
...
def generate_action_replay_code(rom_signature):
    ...
    player_move_orig_instr = 0x012fff1e
    player_move_branch_instr = instr__arm_b(player_move_hook_addr, arm9_start_address, False)
    player_move_branch_instr &= 0x0FFFFFFF
